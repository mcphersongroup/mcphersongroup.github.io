...
# Sort conferences by start date to ensure correct ordering
...
for conf in sorted_conferences:
    conf_start_date = datetime.datetime.strptime(conf["start_date"], "%Y-%m-%d")
    if conf_start_date > current_date:
